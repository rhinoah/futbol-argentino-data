...
- **Quedan 34 partidos sin fecha, y 21 son de una sola temporada.** Eran `148`. Casi nada de lo que se cerró necesitó una fuente nueva: estaba en fuentes que el repo ya bajaba y no leía bien —la fase regular de RSSSF sin encabezado de zona, las divisiones que comparten archivo desde 2010-11, un título que no era título de nada, «repetido» incluyendo al partido publicado sin día, y la fecha **entre paréntesis** de los archivos de 2007-08—. Lo que queda: 21 del `Argentino A 2004-05` —las patas que la fuente citada no publica—, **6 que no esperan ninguna fecha porque no se jugaron** (los que el Federal A 2024 le dio por perdidos a Sansinena, hoy con `status = no disputado`) y 7 sueltos.
