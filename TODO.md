...
`39 875` partidos, cero filas sin fecha. Lo único que queda son verificaciones de calidad, no partidos faltantes: `245` avisos abiertos, y todos los que quedan pueden mover un dato.
