...
|---|---|---|---|---|
| 43 706 | 107 | 149 | 800 | 282 |

## 2004–2026 — Cerrado

**Todo lo que Wikipedia da de esta era está adentro**

`41 237` partidos. Lo único que queda son verificaciones de calidad, no partidos faltantes: del corpus entero quedan `288` avisos abiertos y cero graves, y todos los que quedan pueden mover un dato.
