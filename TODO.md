...
|---|---|---|---|---|
| 43 841 | 148 | 149 | 831 | 306 |

## 2004–2026 — Cerrado

**Todo lo que Wikipedia da de esta era está adentro**

`41 311 ` partidos. Lo único que queda son verificaciones de calidad, no partidos faltantes: del corpus entero quedan `259` avisos abiertos y cero graves, y todos los que quedan pueden mover un dato.
...
- **Los desacuerdos entre el cuadro y la grilla: cerrado.** Eran **56** y son **0**. Las cinco *fases finales que sólo existían como cuadro* entraron desde fuentes externas, y los cuatro que quedaban no eran arbitrajes sino síntomas: a tres les faltaba una pata de la llave y el chequeo comparaba la ida contra la vuelta que publica el dibujo. Lo que los tapaba era un separador: RSSSF alinea en columnas y cuando el nombre la llena justo, el relleno queda en **un solo espacio** — el lector pedía dos y esos renglones se perdían **en silencio**. El cuarto era un homónimo, y lo zanjó la **foja**: la fila de `Juventud Unida` en la tabla dice PJ 20, 6-7-7, 22-24, y RSSSF publica para Juventud Unida Universitario (San Luis) exactamente `20 6 7 7 22-24`.
## 1997–2003 — Cerrado
