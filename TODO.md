...
- **RSSSF: las cinco temporadas están.** `2004-05` (80), `2006-07` (334), `2007-08` (400), `2008-09` (400), `2009-10` (439) y `2012-13` (414, ya con la fuente conectada), todas con cero graves. En 2012-13 quedan **27 partidos que RSSSF no puede fechar**: no publica esa fase partido a partido y, donde el cruce es ambiguo, se niega a fechar en vez de adivinar. `2010-11` y `2011-12` no tienen archivo de partidos en RSSSF y no lo necesitan.
