...
|---|---|---|---|---|
| 43 804 | 148 | 149 | 827 | 302 |

## 2004–2026 — Cerrado

**Todo lo que Wikipedia da de esta era está adentro**

`41 311 ` partidos. Lo único que queda son verificaciones de calidad, no partidos faltantes: del corpus entero quedan `283` avisos abiertos y cero graves, y todos los que quedan pueden mover un dato.
...
- **Quedan 5 desacuerdos entre el cuadro y la grilla.** Empezaron en **56**. Las cinco *fases finales que sólo existían como cuadro* están todas adentro, y el bloque grande —`Argentino A 2004-05`, 16— también: entraron **41 patas** desde el formato compacto de RSSSF. Lo que queda ya no son partidos que falten sino **desacuerdos a arbitrar**: `Argentino A 2012-13` (2) y `Argentino A 2005-06` (2) publican en el cuadro un marcador distinto del de la grilla, y piden un tercer testigo. La quinta, en `Argentino A 2004-05`, tampoco es un partido faltante: el cuadro escribe `Juventud Unida` y RSSSF `Juv. Unida Universitario`, que son **clubes distintos** y los dos jugaron ese torneo — es un choque de nombres.
  - **Las 41 del 2004-05 entraron sin fecha, y a propósito.** Su archivo de RSSSF es el único del corpus en formato *compacto*: las dos patas en un renglón y la fecha como **rango** (`Quarterfinals [Nov 20-28]`). De ahí sale la localía, el marcador de cada pata y la ronda — todo salvo el día. Un rango no es una fecha y no se reparte: el 28 de noviembre no es «la fecha de la vuelta», es el final de una ventana. Van a [`data/sin-fecha/`](data/sin-fecha/LEEME.md), que existe justo para esto, y son las primeras de esa carpeta cuyo *marcador* no sale de Wikipedia.
  - **Si alguien quiere fecharlas**, hay un camino y tiene trampas: un blog (`josecarluccio`) publica las fechas exactas de la 2ª fase del Apertura 2004, corroborado por RSSSF en marcadores y localía — pero **cubre sólo 14 partidos**, tiene una errata demostrable en la misma página (`01/02/2004` por `01/12/2004`) y discrepa un día con RSSSF en la vuelta Douglas Haig – Atlético Tucumán. Hay que pasarlo por un chequeo de coherencia antes de cargarlo.
## 1997–2003 — Cerrado
