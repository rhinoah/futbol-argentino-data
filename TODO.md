...
- **La temporada de RSSSF que queda.** `2004-05` (80), `2006-07` (334), `2007-08` (400), `2008-09` (400) y `2009-10` (439) ya entraron, todas con cero graves. Falta **2012-13** (`arg3-int2013`). De 2004-05 hay que saber que entró **flaca a propósito**: de su fase de grupos Wikipedia publica los resultados de una sola zona —la Norte del Apertura— y de las otras siete nada más que las tablas, y RSSSF tampoco tiene la grilla. Lo que entró son las llaves de las dos Revalidas, las dos fases finales, la permanencia y las promociones. No se inventó el resto.
