...
- **1991–2003 está cacheado, parsea, y son 4.749 partidos.** Los anexos de `Torneo Apertura` y `Torneo Clausura` de esos años ya están en `.cache/` y el parser actual los lee **sin tocar una línea de código**: 190 partidos por temporada, que es exactamente 20 clubes todos contra todos. Se parte en dos mitades por una línea nítida en 1997:
