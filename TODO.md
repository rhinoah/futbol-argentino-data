...
- **Las dos temporadas de RSSSF que quedan.** `2006-07` (334), `2007-08` (400), `2008-09` (400) y `2009-10` (439) ya entraron, las cuatro con cero graves. Quedan **2004-05** (`arg3-int05`) y **2012-13** (`arg3-int2013`), que aparecieron en el barrido y todavía no se miraron. `2010-11` y `2011-12` no tienen archivo de partidos en RSSSF, sólo tablas en el resumen anual; 2010-11 ya entra por Wikipedia.
