...
- **Los 42 avisos del cuadro de llaves.** La fase final no tenía árbitro —todos los chequeos cruzan contra la tabla de posiciones y la tabla habla de las zonas— y ahora el cuadro la arbitra. Se parten en tres: **37** donde la grilla no tiene fase final entre esos dos clubes aunque sí los cruce en la fase regular —o falta el partido, o quedó clasificado como fecha de liga; 19 son del Argentino A 2005-06, cuya fase final existe *sólo* como cuadro—; **3** donde no hay ningún partido entre los dos; y **2 desacuerdos de verdad**, con llave en la grilla y otro número. Los dos tienen la misma forma: el cuadro cierra con su propio global y la grilla está un gol arriba (Federal A 2025, 9 de Julio–Germinal 4-0 contra 5-0; Primera C 2025, Urquiza–Sp. Barracas 0-2 contra 0-3). Adjudicarlos pide una fuente de afuera. El cuadro **no** sirve como fuente de filas: no sabe quién fue local (la convención *arriba es local en la ida* acierta 55.6% contra 761 patas donde la grilla sí lo dice).
