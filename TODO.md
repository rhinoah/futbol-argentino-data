...
- **Dos diferencias más contra RSSSF en la Copa Argentina 2018-19, sin arbitrar.** Aparecieron al medir si RSSSF copia a Wikipedia (no copia: coincide en 14 de 18 cruces de esa ronda, goles y penales exactos). Son `Defensa y Justicia – Gimnasia y Tiro` —2-1 en la página, 1-0 en RSSSF— y `Nueva Chicago – Central Córdoba (SdE)` —1-2 contra 0-1—. **Ningún chequeo las denuncia**, porque el que pasa es el mismo en las dos versiones: sólo se ven poniendo las dos fuentes una al lado de la otra. No se tocan sin mirarlas una por una.
