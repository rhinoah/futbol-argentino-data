...
|---|---|---|---|---|
| 43 835 | 148 | 149 | 868 | 332 |

## 2004–2026 — Cerrado

**Todo lo que Wikipedia da de esta era está adentro**

`41 366` partidos. Lo único que queda son verificaciones de calidad, no partidos faltantes: del corpus entero quedan `222` avisos abiertos y cero graves.
